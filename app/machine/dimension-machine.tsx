...
// The estimator itself — the calculator panel plus its live prediction. Kept
// separate from any page/overlay chrome so it can render both at the /machine
// route and inside the in-page overlay drawer without duplicating logic.
export function DimensionMachine() {
